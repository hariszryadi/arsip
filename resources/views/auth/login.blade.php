...
<body style="background: url({{ asset('images/bg-login.png') }}); background-size: 100% 100%;">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <div class="text-center mb-3">
                                    <img src="{{ asset('images/logo.png') }}" alt="Icon Kab.Bekasi" width="100">
                                    <span class="d-block text-muted">Sistem Informasi Depo Arsip Terpadu</span>
