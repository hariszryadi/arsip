        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group text-left">
                    @can('archives-vital-create')
                        <a href="{{ route('archives-vital.create')}}" class="btn btn-primary mr-2"><i class="icon-file-plus"></i> Tambah</a>
                        ...
                        <a href="{{ route('download-template-archive-vital') }}" class="btn btn-warning"><i class="icon-file-download"></i> Template</a>
                    @endcan
                </div>
...
@section('scripts')
    <script>
        ...
        $('#import-form').on('submit', function (e) {
            ...
            $('#text-loading').show();
            $.ajax({
                url: "{{ route('archives-vital.import') }}",
                method: "POST",
