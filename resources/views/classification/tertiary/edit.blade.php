...
<div class="content-inner">
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" id="form" action="{{ route('tertiary-classification.update', $tertiary->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group" style="margin-top: 50px; margin-left: 10px;">
                        <a class="btn btn-danger" href="{{ route('tertiary-classification.index') }}">Kembali</a>
