...
<div class="content-inner">
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" id="form" action="{{ route('classification.secondary.update', $secondary->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2 @error('code') text-danger @enderror">Kode</label>
                        <div class="col-lg-10">
                            <input type="text" class="form-control @error('code') is-invalid @enderror" name="code" id="code" value="{{ old('code')!== null ? old('code') : $secondary->code }}" placeholder="Kode">
                            @error('code')
